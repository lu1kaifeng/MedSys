...
namespace MedSys
{
    public class Typing
    {
        ...
        public static string[] DeliveryType = new string[] { defaultStr, "膀胱内给药", "泵内注射", "鼻甲注射", "鼻饲", "臂丛麻醉", "表面麻醉", "冲洗", "骶管注射", "动脉给药", "封闭", "腹膜腔内给药", "腹膜腔内注射", "关节内给药", "管道喂养", "灌注", "含服", "肌内注射", "结膜下注射", "经鼻给药", "经耳给药", "经眼给药", "颈丛阻滞", "静脉滴注", "静脉注射", "局部给药", "局部浸润麻醉", "局部注射", "口服", "口腔/咽喉给药", "尿道给药", "皮下注射", "气管/支气管内给药", "前房内注射", "鞘内给药", "球后注射", "舌下给药", "术中栓塞", "漱口", "外用", "吸入给药", "心内注射", "胸膜腔内给药", "胸膜腔内注射", "血液透析", "眼球内给药", "羊膜腔内给药", "阴道给药", "硬膜外给药", "造瘘管注入", "直肠给药", "植入给药", "肿瘤内注射", "蛛网膜下腔给药", "注射", "椎管给药", "子宫颈给药", "子宫内给药", "牙科给药", "肝动脉灌注", "皮内注射", "不详" };
        public static string[] FocusTypeType = new string[] { defaultStr, "新冠肺炎防控品种","4 + 7集中采购品种","创新药品种","中药关注品种"};
        public static string[] ReportSubject = new string[] {"医疗机构",
"持有人自主上报",
"经营企业",
"持有人反馈上报",
"其他" };
